...
class frame(object):
    ...
    def __init__(self, dert__, blob_map = None, num_params = 7):
        ...
        self.blob_map = blob_map        # initially there's no blob_map (in the global frame)
...
class P(frame):
    ...
    def __init__(self, y, x_start = 0, num_params = 5, sign=-1):
        " constructor function of P "

        self.sign = sign            # either 0 or 1 normally. -1 for unknown sign
        self.boundaries = [x_start] # initialize boundaries with only x_start
    ...
    def terminate(self, x_end):
        ...
        self.boundaries += [x_end, self.y]  # complete boundaries with x_end and y
        del self.y
        return self
...
class segment(P):
    ...
    def __init__(self, P, fork_ = []):
        " constructor function of segment. Takes P and fork_ to initialize segment"

        self.sign = P.sign                      # same sign with init P
        ...
        self.ave_x = (P.L() - 1) // 2           # ave_x
        self.Py_ = [(P, 0)]                     # Py_
        self.roots = 0                          # roots
        self.fork_ = fork_                      # fork_
...
class blob(segment):
    ...
    def term_segment(self, segment, y):
        ...
        self.accum_params(segment.orientation_params + [len(segment.Py_)], 'orientation_params') # accum orientation params: [xD, abs_xD, Ly]
    ...
    def localize(self, frame, copy_dert__ = 1):
        ...
        x0, xn, y0, yn = self.boundaries    # x_start, x_end, y_start, y_end in short
        ...
        for seg in self.segment_:
            ...
            for P, xd in seg.Py_:
                ...
                if copy_dert__:
                    ...
                    blob_map[y, x_start:x_end] = True   # in the rectangular blob_map, pixels inside the blob = True
