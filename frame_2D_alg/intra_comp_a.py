...
def comp_r2(dert__, fig, root_fcr):
    """
...
def comp_g2(dert__):  # cross-comp of g in 2x2 kernels, between derts in ma.stack dert__
    '''
    ...
    cos_da1__ = (dy1__ * dx1__) + (dy2__ * dx2__)  # top right to bottom left angles
