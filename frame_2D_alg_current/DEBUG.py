...
def draw_blob_(path, frame, debug_ablob=0, debug_parts=0, debug_local=0, show=0):
    " Decode blob_ to image "
                ...
                for ablob_idx, ablob in enumerate(ablob_):
                    ...
                    for aseg in ablob.segment_:
                        ...
                        for (aP, xd) in aseg.Py_:
                            ...
                            y += 1
                    if debug_parts:
                        x0, xn, y0, yn = [b + blob.x0() for b in ablob.box[:2]] + [b + blob.y0() for b in ablob.box[2:]]
